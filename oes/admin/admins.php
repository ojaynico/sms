        ...
        <div class="page">
            ...
            if (isset($_SESSION['admname'])) {
                ...
                if (isset($_REQUEST['add'])) {
                    ...
                    $result = executeQuery("select id,admname, DECODE(admpassword) as admpass, admname, admpass from adminlogin where id='" . htmlspecialchars($_REQUEST['edit'], ENT_QUOTES) . "';");
