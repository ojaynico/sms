...
background: linear-gradient(#ffdd7f 5%, #ffbc00 100%);
     ...
     <?php $this->load->view('dashboard/header'); ?>
        ...
        <div id="loaddi" class="container">
            <div class="card-panel hoverable z-depth-5 teal lighten-5">
            
           <center><h5>Statistics of accounts today</h5>
        ...
        $this->db->where('creation_timestamp','CURDATE()',FALSE);
        $ic = $this->db->get('invoice')->row();
        ?>
    <div class="row">
    <div class="input-field col s12">
       <label><b> Cash in today</b></label>
       <input type="text" value="<?php echo $ic->amount_paid;?>" readonly name="in" id="in" placeholder="0000.00" class="hoverable">
    </div></div>
    ...
    <div class="row">
    <div class="input-field col s12">
        <label><b>Cash out today:</b></label>
        <input type="text" value="<?php echo $e->amount?>" readonly name="out" id="out" placeholder="0000.00" class="hoverable">
    </div></div>
    ...
    <div class="input-field col s12">   
        ...
        <label><b>School Cash balance:</b></label>
        <input type="text" value=" <?php echo $query->amount_paid - $ex->amount;?> " readonly name="balance" id="balance" class="hoverable">
    </div></div>  
