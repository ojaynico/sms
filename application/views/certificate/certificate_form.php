...
<section id="main-content">
    <div class="container-fluid">
        <button title="Back" class="btn-floating btn-small waves-effect waves-light green">
            <a href = "<?php echo base_url(); ?>certificate_c/newCertificate"><i class="small material-icons">fast_rewind</i></a></button>
        <center> <h4>Certificate form</h4></center>
        <form action="<?php echo base_url(); ?>certificate_c/addCertificate" method="post" enctype="multipart/form-data" class="card">
            <input type="hidden" value="<?php if (isset($student)){ foreach ($student as $s) echo $s->id; } ?>" name="reg_id">
            <div class="row">
                <div class="col m3">
                    <div class="input-field">
                        <label for="studentName">Student Name</label>
                        <input class="validate" id="studentName" name="studentName" type="text" value="<?php if (isset($student)){ foreach ($student as $s) echo $s->st_name; } ?>">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="studentContact" name="studentContact" type="number" length="10" value="<?php if (isset($student)){ foreach ($student as $s) echo $s->st_mobile; } ?>">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="whatsapp" name="whatsapp" type="number" length="10">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="fathersName" name="fathersName" type="text">
            ...
            <div class="row">
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="fathersContact" name="fathersContact" type="number" length="10">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="mothersName" name="mothersName" type="text">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="mothersContact" name="mothersContact" type="number" length="10">
            ...
            <div class="row">
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="datepicker" id="dob" name="dob" type="date">
            ...
            <div class="row">
                <div class="col m3">
                    <div class="input-field">
                        <label for="company_college">Company/College</label>
                        <input class="validate" id="company_college" name="company_college" type="text">
                ...
                <div class="col m3">
                    <div class="input-field">
                        ...
                        <input class="validate" id="dream" name="dream" type="text">
                ...
                <div class="col m3">
                    ...
                    <input type="text" class="form-control text-center" readonly value="<?php echo date('Y-m-d'); ?>" id="date" name="date">
                    </div>
                </div>
            ...
            <div class="row right">
                <div class="col s12">
                    <button class="btn red" type="reset"><i class="material-icons right">restore</i>Reset</button>
                    <button class="btn green" type="submit"><i class="material-icons right">send</i>Submit</button>
                </div>
            </div>
            <br/>
        </form>
