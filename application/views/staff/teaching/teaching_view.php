...
<section id="main-content" style="height: 1024px">
    <div class="inner-content">
        <div class="container-fluid">
            ...
            <center><h4>Teacher form</h4></center>
            <form method="POST" action="<?php echo base_url(); ?>teacher" class="card">
                ...
                <div class="row">
                    ...
                    <div class="col l4 m6 s12">
                        ...
                        <select name="emp_type" class="browser-default">
                            <option value=""><?php echo 'select your type'; ?></option>
                ...
                <div class="row">
                    <div class="col l4 m6 s12">
                        ...
                        <select name="designation" class="browser-default">
                            <option value=""><?php echo 'select designation'; ?></option>
