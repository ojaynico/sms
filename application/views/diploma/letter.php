    ...
    <div class="container-fluid" id="printLetter">
        ...
        <?php if ($_GET['type'] == 1){ ?>
            ...
            <div class="row">
                <div class="col l12">
                    <p>
                        We are very pleased to advise you that we are prepared to admit you as a diploma candidate in
                        <b>
                            <?php
        ...
        <?php if ($_GET['type'] == 2){ ?>
            ...
            <div class="row">
                <div class="col l12">
                    <p>
                        Congratulations! You have been selected for a course at Sai Pali Institute of Technology & Management. The Admissions Committee has been given careful consideration to your application for admission in diploma in
                        <b>
                            <?php
                            $query = $this->db->query("SELECT name FROM courses WHERE id = $s->course");
                            $result = $query->result();
